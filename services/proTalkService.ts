...
export class ProTalkService {
  ...
  private getFallbackResponse(message: string): string {
    ...
    return 'Интересный вопрос. В контексте делегирования важно помнить: делегируйте рутину, оставляйте себе стратегию. Могу подробнее рассказать о матрице выбора задач или о оценке сотрудников.';
  }
}
