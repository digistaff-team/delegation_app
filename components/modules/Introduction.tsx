    ...
    <div className="max-w-3xl mx-auto space-y-8 animate-fade-in">
      ...
      <section className="bg-white rounded-2xl p-8 shadow-sm border border-slate-100">
        ...
        <div className="prose prose-slate max-w-none text-slate-600">
          ...
          <p>
            Однако, без делегирования вы рискуете перегореть, утонув в операционке. Вы становитесь "узким горлышком" для своей команды.
          </p>
        </div>
      </section>
      ...
      <div className="bg-blue-50 border border-blue-100 rounded-2xl p-6">
        ...
        <p className="text-blue-800 text-sm">
          Способность делегировать показывает масштаб мышления руководителя. Способен мыслить задачами команды - может делегировать. Думает только о своём результате - не делегирует.
        </p>
      </div>
